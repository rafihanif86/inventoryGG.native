                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="dashboard_admin.php">Tabel Daftar Peminjaman</a></li>
                            <li><i class="fa fa-table"></i><a href="vendor_producttampil.php">Tabel Alat</a></li>
                            <li><i class="fa fa-table"></i><a href="customer_tampilAkun.html">Tabel Akun</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Forms</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="vendor_form.php">Tambah Alat</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard_admin.php"><img src="images/gg.png" alt="" style="padding-left:10px;padding-top:10px;width:100%;hight:100%"></a>
